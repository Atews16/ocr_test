...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public void onCreate(Bundle icicle) {
    ...
    Toast.makeText(getApplicationContext(),ocrResultView.getText().toString(),Toast.LENGTH_SHORT).show();
    ...
    go.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        String res=ocrResultView.getText().toString();
        if(!res.equals(""))
        {
          Toast.makeText(getApplicationContext(),res,Toast.LENGTH_SHORT).show();
        //  Intent intent=new Intent(getApplicationContext(),Db.class);
        //  intent.putExtra("tankid",res);
        //  startActivity(intent);
        }
        else
        {
          Toast.makeText(getApplicationContext(),"Click the Tank ID properly...",Toast.LENGTH_SHORT).show();
        }
      }
    });
